...
static void test_one(void **state)
{
    ...
    char *dut[3] = { ".include \"../../../test/spice/S4020L.txt\"" };
    /*                       A    G    K */
    ...
    assert_uint_equal(result_p->component, COMPONENT_THYRISTOR);
    /* TODO: what exactly are these values and are they correct? */
    assert_float_equal(result_p->bjt_ube, 0.16f, 0.01f);
    assert_float_equal(result_p->diode_vf, 0.64f, 0.01f);
